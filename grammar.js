...
module.exports = grammar({
  ...
  rules: {
    ...
    binary_expresion: $ => choice(
      ...
      prec.left(6, seq($._expression, ">>", $._expression)),
      prec.left(6, seq($._expression, "bit_and", $._expression)),
      prec.left(6, seq($._expression, "&", $._expression)),
      prec.left(6, seq($._expression, "bit_or", $._expression)),
      prec.left(6, seq($._expression, "|", $._expression)),
      prec.left(6, seq($._expression, "xor", $._expression)),
    ),
    unary_expresion: $ => choice(
      prec.left(7, seq("+", $._expression)),
      prec.left(7, seq("-", $._expression)),
      prec.left(7, seq("not", $._expression)),
      prec.left(7, seq("!", $._expression)),
      prec.left(7, seq("bit_not", $._expression)),
      prec.left(7, seq("~", $._expression)),
    ),
    _literal: $ => choice(
      $.integer_literal,
